...
#ifndef UNDEROCEAN_LEVELSCENE4_H
#define UNDEROCEAN_LEVELSCENE4_H
#include "LevelSceneBase.h"
#include "server/new/component/Components.h"

class LevelScene4 : public LevelSceneBase {
public:
    explicit LevelScene4(const std::shared_ptr<ClientNetworkDriver>& driver, ClientCommonPlayerAttributes& playerAttributes, const std::shared_ptr<ChatBox>& chatBox)
        ...
        // }
        background_.setTexture(ResourceManager::getTexture("images/backgrounds/bg4.png"));
        writer_.writeInt8(static_cast<std::uint8_t>(4));  //to level 1
        driver_->send(writer_.takePacket(), 0, ServerTypes::PacketType::PKT_LEVEL_CHANGE, 1);
        writer_.clearBuffer();
    }

protected:
    int getLevelNum() override { return 4; };
...
#endif //UNDEROCEAN_LEVELSCENE4_H