...
#ifndef UNDEROCEAN_LEVELSCENE3_H
#define UNDEROCEAN_LEVELSCENE3_H
#include "LevelSceneBase.h"
#include "server/new/component/Components.h"

class LevelScene3 : public LevelSceneBase {
public:
    explicit LevelScene3(const std::shared_ptr<ClientNetworkDriver>& driver, ClientCommonPlayerAttributes& playerAttributes, const std::shared_ptr<ChatBox>& chatBox)
        ...
        // }
        background_.setTexture(ResourceManager::getTexture("images/backgrounds/bg3.png"));
        writer_.writeInt8(static_cast<std::uint8_t>(3));  //to level 1
        driver_->send(writer_.takePacket(), 0, ServerTypes::PacketType::PKT_LEVEL_CHANGE, 1);
        writer_.clearBuffer();
    }

protected:
    int getLevelNum() override { return 3; };
...
#endif //UNDEROCEAN_LEVELSCENE3_H