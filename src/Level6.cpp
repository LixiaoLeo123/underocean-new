...
void Level6::initialize() {
    ...
    entityFactory_.addWeightedEntry(EntityTypeID::FLY_FISH, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::RED_LIGHT, 0.05);
    entityFactory_.addWeightedEntry(EntityTypeID::TURTLE, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::UGLY_FISH, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::SMALL_YELLOW, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::BALL_ORANGE, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::BLUE_LONG, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::ROUND_GREEN, 0.7);
    entityFactory_.addWeightedEntry(EntityTypeID::SMALL_SHARK, 0.01);
